...
def powerball():
    ...
    pb_draw = f"Ticket price to play $2. Drawings are held Mon. Wed. & Sat." 
...
def lucky_life():
    ...
    lucky_draw = f"Ticket price to play $2. Drawings held Daily"
...
def two_by_two(): 
    ...
    two_draw = f"Ticket price to play $1. Drawings held Daily around 8:30pm MT"
