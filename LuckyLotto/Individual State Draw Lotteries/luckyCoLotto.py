...
def mega_millions():
    ...
    mm_drawings = f"Base ticket price $5. Cut-off time to play is 8pm MT night of drawings. Drawings are held Tues. Fri. 9pm MT."
    ...
    while True:
            try:
                ...
                if co_lotto_game_choice in co_lotto_draw_games:
                    for result in co_lotto_draw_games[co_lotto_game_choice]():
                        print(result)
                    break 
                else:
