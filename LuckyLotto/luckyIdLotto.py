...
def powerball():
    ...
    pb_draw = "Ticket price to play $3. Drawings are held Mon. Wed. & Sat." 
    pb_add = "Powerplay option available with every play."
    pb_add2 = "Double Play add on $1 extra"
    pb_official = "Official Rules and Play can be found- https://www.idaholottery.com/games/draw/powerball Good Luck!"    
...
def mega_millions():
    ...
    mm_rules = "Official Rules and Play can be found- https://www.idaholottery.com/games/draw/mega-millions Good Luck!"    
...
def lotto_america():
    ...
    lotto_draw = "Ticket price to play $1. Drawings are held Mon. Wed. & Sat. 9pm MT"
    lotto_add = "Add on- All-Star Multiplier available for $1 extra"
    lotto_rules = "Official Rules and Play can be found- https://www.idaholottery.com/games/draw/lotto-america Good Luck!"
...
def lucky_life():
    ...
    lucky_draw = "Ticket price to play $2. Drawings held Daily 8:35pm MT"
    lucky_rules = "Official Rules and Gameplay can be found- https://www.idaholottery.com/games/draw/lucky-for-life Good Luck!"
    return (lucky_main, lucky_draw, lucky_rules)


def idaho_cash(): 
    cash_num = sorted(random.sample(range(1, 46), 5))
    cash_main = f"\nIdaho Cash Lucky Numbers: {cash_num}"
    cash_draw = "Ticket price to play $1. Drawings held Nightly at 8pm MT."
    cash_rules = "Official Rules and Gameplay can be found- https://www.idaholottery.com/games/draw/idaho-cash Good Luck!"
...
def pick3():
    ...
    p3_now = "Multiple ways to Play and WIN!!! Check official site for Gameplay."
    p3_drawings = "Ticket price to play $1.\nDrawings held Daily: Day 1:59pm MT and Night 7:59pm MT." 
    p3_add = 'Available Add-on is "Sum it Up" for $1 extra.'     
    p3_rules = "Official Rules and Play can be found- https://www.idaholottery.com/games/draw/pick-3 Good Luck!"    
...
def pick4():
    ...
    p4_now = "Multiple ways to Play and WIN!!! Check official site for Gameplay."
    p4_drawings = "Ticket price to play $1.\nDrawings held Daily: Day 1:59pm MT and Night 7:59pm MT." 
    p4_add = 'Available Add-on is "Sum it Up" for $1 extra.'     
    p4_rules = "Official Rules and Play can be found- https://www.idaholottery.com/games/draw/pick-4 Good Luck!"    
...
def play_game():
    ...
    while True:
        try:
            id_lotto_game_choice = int(input("\nWhich Lucky Game would you like to try: "))
