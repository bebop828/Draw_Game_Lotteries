...
def powerball():
    ...
    pb_draw = f"Base ticket price $2. Drawings are held Mon. Wed. & Sat. 9:59 p.m CST." 
    pb_add = f"Available add on- Power Play $1 extra."
    pb_official = f"Official Rules and Play can be found- https://louisianalottery.com/draw-games/powerball/ Good Luck!"    
...
def mega_millions():
    ...
    mm_drawings = f"Base ticket price $5."
    mm_drawings2 = f"Mega Millions drawings are broadcast live from Atlanta, Georgia on Tues and Fri 10 p.m. CST. "
    mm_add = f"Megaplier available with every play."
    mm_rules = f"Official Rules and Play can be found- https://louisianalottery.com/draw-games/mega-millions/ Good Luck!"    
...
def la_lotto():
    ...
    lott_drawings = f"Base ticket price $1. Drawings are held Wed. & Sat. 9:59pm."
...
def easy_5():
    ...
    easy_drawings = f"Base ticket price $1. Drawings are held Wed. & Sat."
...
def la_pic_3():
    ...
    p3_drawings = f"Base ticket prices are $.50 or $1. Drawings are held Daily."      
...
def la_pic_4():
    ...
    p4_drawings = f"Base ticket prices are $.50 or $1. Drawings are held Daily."      
...
def la_pic_5():
    ...
    p5_drawings = f"Base ticket prices are $.50 or $1. Drawings are held Daily."      
